...
public class AbilityProductController {
    ...
    private final static String VIEW_FIND_IN_DISCARD = "abilities/findInDiscard";
    ...
    public AbilityProductController(UserService userService, PlayerService playerService, CacheManager cacheManager, DeckService deckService) {
