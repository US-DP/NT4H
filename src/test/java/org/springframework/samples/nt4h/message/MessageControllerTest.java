...
class MessageControllerTest {
    ...
    void testInitCreationForm() {
        ...
        messageController.initCreationForm("The Rock", new ModelMap());
    }
    ...
    void testSendMessage3() {
        ...
        user1.setStatistic(statistic);
        user1.setTier(Tier.IRON);
        user1.setUsername("Finn");
    ...
    void testSendInviteMessage() {
        ...
        messageController.sendInviteMessage("Finn");
    }
