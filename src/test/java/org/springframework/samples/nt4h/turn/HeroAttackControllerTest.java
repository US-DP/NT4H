...
import org.springframework.samples.nt4h.turn.hero_attack.HeroAttackController;
...
@ContextConfiguration(classes = {HeroAttackController.class})
@ExtendWith(SpringExtension.class)
class HeroAttackControllerTest {
    @MockBean
    ...
    void testNext() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/heroAttack/next");
        MockMvcBuilders.standaloneSetup(heroAttackController)
            .build()
