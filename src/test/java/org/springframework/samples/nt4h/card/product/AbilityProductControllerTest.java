...
@ContextConfiguration(classes = {AbilityProductController.class})
@ExtendWith(SpringExtension.class)
class AbilityProductControllerTest {
    @Autowired
    private AbilityProductController abilityProductController;
    ...
    void testConcentrationVial() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(abilityProductController)
            ...
            .andExpect(
                MockMvcResultMatchers.model().attributeExists("currentPlayer", "game", "loggedUser", "logggedPlayer"))
